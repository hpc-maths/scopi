...
namespace scopi
{
    ...
    //     template <>
    //     void
    //     set_params_test<OptimUzawaMatrixFreeTbb<ViscousWithoutFriction<2>>>(OptimParams<OptimUzawaMatrixFreeTbb<ViscousWithoutFriction<2>>>&
    //     params)
    //     {
    //         set_params_test_uzawa(params);
    //     }
    ...
    //     template <>
    //     void
    //     set_params_test<OptimUzawaMatrixFreeOmp<ViscousWithoutFriction<2>>>(OptimParams<OptimUzawaMatrixFreeOmp<ViscousWithoutFriction<2>>>&
    //     params)
    //     {
    //         set_params_test_uzawa(params);
    //     }
