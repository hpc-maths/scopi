...
if __name__ == '__main__':
    ...
    def f_contacts(u,s1,s2):
        ...
        res_ref[0] = -(M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-M20*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M21*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M22*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N20*s2rx*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2)) + N21*s2ry*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2)) + N22*s2rz*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2)) - s1zc + s2zc) + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-M10*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M11*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M12*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N10*s2rx*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2)) + N11*s2ry*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2)) + N12*s2rz*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2)) - s1yc + s2yc)

        res_ref[1] = (M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-M20*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M21*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M22*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N20*s2rx*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2)) + N21*s2ry*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2)) + N22*s2rz*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2)) - s1zc + s2zc) - (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-M00*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M01*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M02*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N00*s2rx*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2)) + N01*s2ry*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2)) + N02*s2rz*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2)) - s1xc + s2xc)

        res_ref[2] = -(M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-M10*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M11*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M12*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N10*s2rx*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2)) + N11*s2ry*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2)) + N12*s2rz*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2)) - s1yc + s2yc) + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-M00*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M01*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M02*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N00*s2rx*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2)) + N01*s2ry*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2)) + N02*s2rz*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2)) - s1xc + s2xc)

        res_ref[3] = (M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(N00*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N01*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N02*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2))) + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(N10*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N11*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N12*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2))) + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(N20*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N21*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N22*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2))) + np.sqrt((M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2 + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2 + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2)*np.sqrt((N00*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N01*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N02*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))**2 + (N10*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N11*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N12*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))**2 + (N20*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N21*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N22*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))**2)
    ...
    def grad_f_contacts(u,s1,s2):
        ...
        ca2n2 = np.abs(ca2)**(2 - s2n)
        ca2n3 = (2 - s2n)*np.sign(ca2)*np.abs(ca2)**(1 - s2n)
        ...
        B14 = s2rx * s2ry * np.abs(ca2) * sa2n3
        ...
        res_ref[0,0] = (-M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) - M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) - M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(M20*s1n*s1rx*np.sin(a1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))**2*np.sign(np.cos(b1))/np.abs(np.cos(a1)) + 2*M20*s1rx*np.sin(a1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*DiracDelta(np.cos(a1))*np.sign(np.cos(b1)) + M21*s1n*s1ry*np.sin(a1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1))**2/np.abs(np.cos(a1)) + 2*M21*s1ry*np.sin(a1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*DiracDelta(np.cos(a1))*np.sign(np.sin(b1)) - M22*s1n*s1rz*np.cos(a1)*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1))**2/np.abs(np.sin(a1)) - 2*M22*s1rz*np.cos(a1)*np.abs(np.sin(a1))**s1n*DiracDelta(np.sin(a1))) + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(M10*s1n*s1rx*np.sin(a1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))**2*np.sign(np.cos(b1))/np.abs(np.cos(a1)) + 2*M10*s1rx*np.sin(a1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*DiracDelta(np.cos(a1))*np.sign(np.cos(b1)) + M11*s1n*s1ry*np.sin(a1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1))**2/np.abs(np.cos(a1)) + 2*M11*s1ry*np.sin(a1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*DiracDelta(np.cos(a1))*np.sign(np.sin(b1)) - M12*s1n*s1rz*np.cos(a1)*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1))**2/np.abs(np.sin(a1)) - 2*M12*s1rz*np.cos(a1)*np.abs(np.sin(a1))**s1n*DiracDelta(np.sin(a1))) + (M10*s1ry*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(a1))*np.sign(np.cos(b1))/np.abs(np.cos(a1)) + M11*s1rx*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))*np.sign(np.cos(a1))/np.abs(np.cos(a1)) - M12*s1rx*s1ry*(2 - s1n)*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))**2*np.sign(np.cos(a1))/np.abs(np.sin(a1)) + 2*M12*s1rx*s1ry*np.sin(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.cos(a1))*np.sign(np.sin(a1)) - 2*M12*s1rx*s1ry*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.sin(a1))*np.sign(np.cos(a1)))*(-M20*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M21*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M22*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N20*s2rx*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2)) + N21*s2ry*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2)) + N22*B3 - s1zc + s2zc) + (-M20*s1ry*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(a1))*np.sign(np.cos(b1))/np.abs(np.cos(a1)) - M21*s1rx*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))*np.sign(np.cos(a1))/np.abs(np.cos(a1)) + M22*s1rx*s1ry*(2 - s1n)*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))**2*np.sign(np.cos(a1))/np.abs(np.sin(a1)) - 2*M22*s1rx*s1ry*np.sin(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.cos(a1))*np.sign(np.sin(a1)) + 2*M22*s1rx*s1ry*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.sin(a1))*np.sign(np.cos(a1)))*(-M10*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M11*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M12*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N10*s2rx*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2)) + N11*s2ry*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2)) + N12*s2rz*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2)) - s1yc + s2yc)

        res_ref[0,1] = (-M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) - M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) - M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(M20*s1e*s1rx*np.sin(b1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) + 2*M20*s1rx*np.sin(b1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*DiracDelta(np.cos(b1))*np.sign(np.cos(a1)) - M21*s1e*s1ry*np.cos(b1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))**2*np.sign(np.cos(a1))/np.abs(np.sin(b1)) - 2*M21*s1ry*np.cos(b1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*DiracDelta(np.sin(b1))*np.sign(np.cos(a1))) + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(M10*s1e*s1rx*np.sin(b1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) + 2*M10*s1rx*np.sin(b1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*DiracDelta(np.cos(b1))*np.sign(np.cos(a1)) - M11*s1e*s1ry*np.cos(b1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))**2*np.sign(np.cos(a1))/np.abs(np.sin(b1)) - 2*M11*s1ry*np.cos(b1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*DiracDelta(np.sin(b1))*np.sign(np.cos(a1))) + (M10*s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) + 2*M10*s1ry*s1rz*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*DiracDelta(np.cos(b1)) - M11*s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))**2/np.abs(np.sin(b1)) - 2*M11*s1rx*s1rz*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*DiracDelta(np.sin(b1)))*(-M20*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M21*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M22*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N20*s2rx*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2)) + N21*s2ry*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2)) + N22*s2rz*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2)) - s1zc + s2zc) + (-M20*s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) - 2*M20*s1ry*s1rz*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*DiracDelta(np.cos(b1)) + M21*s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))**2/np.abs(np.sin(b1)) + 2*M21*s1rx*s1rz*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*DiracDelta(np.sin(b1)))*(-M10*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M11*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M12*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N10*s2rx*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2)) + N11*s2ry*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2)) + N12*s2rz*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2)) - s1yc + s2yc)

        res_ref[0,2] = (-M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) - M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) - M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-N20*s2n*s2rx*np.sin(a2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))**2*np.sign(np.cos(b2))/np.abs(np.cos(a2)) - 2*N20*s2rx*np.sin(a2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*DiracDelta(np.cos(a2))*np.sign(np.cos(b2)) - N21*s2n*s2ry*np.sin(a2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2))**2/np.abs(np.cos(a2)) - 2*N21*s2ry*np.sin(a2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*DiracDelta(np.cos(a2))*np.sign(np.sin(b2)) + N22*s2n*s2rz*np.cos(a2)*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2))**2/np.abs(np.sin(a2)) + 2*N22*s2rz*np.cos(a2)*np.abs(np.sin(a2))**s2n*DiracDelta(np.sin(a2))) + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-N10*s2n*s2rx*np.sin(a2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))**2*np.sign(np.cos(b2))/np.abs(np.cos(a2)) - 2*N10*s2rx*np.sin(a2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*DiracDelta(np.cos(a2))*np.sign(np.cos(b2)) - N11*s2n*s2ry*np.sin(a2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2))**2/np.abs(np.cos(a2)) - 2*N11*s2ry*np.sin(a2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*DiracDelta(np.cos(a2))*np.sign(np.sin(b2)) + N12*s2n*s2rz*np.cos(a2)*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2))**2/np.abs(np.sin(a2)) + 2*N12*s2rz*np.cos(a2)*np.abs(np.sin(a2))**s2n*DiracDelta(np.sin(a2)))

        res_ref[0,3] = (-M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) - M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) - M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-N20*s2e*s2rx*np.sin(b2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2))**2/np.abs(np.cos(b2)) - 2*N20*s2rx*np.sin(b2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*DiracDelta(np.cos(b2))*np.sign(np.cos(a2)) + N21*s2e*s2ry*np.cos(b2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))**2*np.sign(np.cos(a2))/np.abs(np.sin(b2)) + 2*N21*s2ry*np.cos(b2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*DiracDelta(np.sin(b2))*np.sign(np.cos(a2))) + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-N10*s2e*s2rx*np.sin(b2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2))**2/np.abs(np.cos(b2)) - 2*N10*s2rx*np.sin(b2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*DiracDelta(np.cos(b2))*np.sign(np.cos(a2)) + N11*s2e*s2ry*np.cos(b2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))**2*np.sign(np.cos(a2))/np.abs(np.sin(b2)) + 2*N11*s2ry*np.cos(b2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*DiracDelta(np.sin(b2))*np.sign(np.cos(a2)))

        res_ref[1,0] = (M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(M20*s1n*s1rx*np.sin(a1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))**2*np.sign(np.cos(b1))/np.abs(np.cos(a1)) + 2*M20*s1rx*np.sin(a1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*DiracDelta(np.cos(a1))*np.sign(np.cos(b1)) + M21*s1n*s1ry*np.sin(a1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1))**2/np.abs(np.cos(a1)) + 2*M21*s1ry*np.sin(a1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*DiracDelta(np.cos(a1))*np.sign(np.sin(b1)) - M22*s1n*s1rz*np.cos(a1)*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1))**2/np.abs(np.sin(a1)) - 2*M22*s1rz*np.cos(a1)*np.abs(np.sin(a1))**s1n*DiracDelta(np.sin(a1))) + (-M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) - M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) - M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(M00*s1n*s1rx*np.sin(a1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))**2*np.sign(np.cos(b1))/np.abs(np.cos(a1)) + 2*M00*s1rx*np.sin(a1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*DiracDelta(np.cos(a1))*np.sign(np.cos(b1)) + M01*s1n*s1ry*np.sin(a1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1))**2/np.abs(np.cos(a1)) + 2*M01*s1ry*np.sin(a1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*DiracDelta(np.cos(a1))*np.sign(np.sin(b1)) - M02*s1n*s1rz*np.cos(a1)*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1))**2/np.abs(np.sin(a1)) - 2*M02*s1rz*np.cos(a1)*np.abs(np.sin(a1))**s1n*DiracDelta(np.sin(a1))) + (-M00*s1ry*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(a1))*np.sign(np.cos(b1))/np.abs(np.cos(a1)) - M01*s1rx*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))*np.sign(np.cos(a1))/np.abs(np.cos(a1)) + M02*s1rx*s1ry*(2 - s1n)*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))**2*np.sign(np.cos(a1))/np.abs(np.sin(a1)) - 2*M02*s1rx*s1ry*np.sin(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.cos(a1))*np.sign(np.sin(a1)) + 2*M02*s1rx*s1ry*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.sin(a1))*np.sign(np.cos(a1)))*(-M20*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M21*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M22*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N20*s2rx*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2)) + N21*s2ry*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2)) + N22*s2rz*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2)) - s1zc + s2zc) + (M20*s1ry*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(a1))*np.sign(np.cos(b1))/np.abs(np.cos(a1)) + M21*s1rx*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))*np.sign(np.cos(a1))/np.abs(np.cos(a1)) - M22*s1rx*s1ry*(2 - s1n)*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))**2*np.sign(np.cos(a1))/np.abs(np.sin(a1)) + 2*M22*s1rx*s1ry*np.sin(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.cos(a1))*np.sign(np.sin(a1)) - 2*M22*s1rx*s1ry*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.sin(a1))*np.sign(np.cos(a1)))*(-M00*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M01*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M02*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N00*s2rx*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2)) + N01*s2ry*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2)) + N02*s2rz*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2)) - s1xc + s2xc)

        res_ref[1,1] = (M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(M20*s1e*s1rx*np.sin(b1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) + 2*M20*s1rx*np.sin(b1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*DiracDelta(np.cos(b1))*np.sign(np.cos(a1)) - M21*s1e*s1ry*np.cos(b1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))**2*np.sign(np.cos(a1))/np.abs(np.sin(b1)) - 2*M21*s1ry*np.cos(b1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*DiracDelta(np.sin(b1))*np.sign(np.cos(a1))) + (-M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) - M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) - M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(M00*s1e*s1rx*np.sin(b1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) + 2*M00*s1rx*np.sin(b1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*DiracDelta(np.cos(b1))*np.sign(np.cos(a1)) - M01*s1e*s1ry*np.cos(b1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))**2*np.sign(np.cos(a1))/np.abs(np.sin(b1)) - 2*M01*s1ry*np.cos(b1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*DiracDelta(np.sin(b1))*np.sign(np.cos(a1))) + (-M00*s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) - 2*M00*s1ry*s1rz*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*DiracDelta(np.cos(b1)) + M01*s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))**2/np.abs(np.sin(b1)) + 2*M01*s1rx*s1rz*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*DiracDelta(np.sin(b1)))*(-M20*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M21*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M22*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N20*s2rx*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2)) + N21*s2ry*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2)) + N22*s2rz*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2)) - s1zc + s2zc) + (M20*s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) + 2*M20*s1ry*s1rz*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*DiracDelta(np.cos(b1)) - M21*s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))**2/np.abs(np.sin(b1)) - 2*M21*s1rx*s1rz*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*DiracDelta(np.sin(b1)))*(-M00*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M01*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M02*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N00*s2rx*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2)) + N01*s2ry*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2)) + N02*s2rz*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2)) - s1xc + s2xc)

        res_ref[1,2] = (M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-N20*s2n*s2rx*np.sin(a2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))**2*np.sign(np.cos(b2))/np.abs(np.cos(a2)) - 2*N20*s2rx*np.sin(a2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*DiracDelta(np.cos(a2))*np.sign(np.cos(b2)) - N21*s2n*s2ry*np.sin(a2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2))**2/np.abs(np.cos(a2)) - 2*N21*s2ry*np.sin(a2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*DiracDelta(np.cos(a2))*np.sign(np.sin(b2)) + N22*s2n*s2rz*np.cos(a2)*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2))**2/np.abs(np.sin(a2)) + 2*N22*s2rz*np.cos(a2)*np.abs(np.sin(a2))**s2n*DiracDelta(np.sin(a2))) + (-M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) - M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) - M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-N00*s2n*s2rx*np.sin(a2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))**2*np.sign(np.cos(b2))/np.abs(np.cos(a2)) - 2*N00*s2rx*np.sin(a2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*DiracDelta(np.cos(a2))*np.sign(np.cos(b2)) - N01*s2n*s2ry*np.sin(a2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2))**2/np.abs(np.cos(a2)) - 2*N01*s2ry*np.sin(a2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*DiracDelta(np.cos(a2))*np.sign(np.sin(b2)) + N02*s2n*s2rz*np.cos(a2)*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2))**2/np.abs(np.sin(a2)) + 2*N02*s2rz*np.cos(a2)*np.abs(np.sin(a2))**s2n*DiracDelta(np.sin(a2)))

        res_ref[1,3] = (M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-N20*s2e*s2rx*np.sin(b2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2))**2/np.abs(np.cos(b2)) - 2*N20*s2rx*np.sin(b2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*DiracDelta(np.cos(b2))*np.sign(np.cos(a2)) + N21*s2e*s2ry*np.cos(b2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))**2*np.sign(np.cos(a2))/np.abs(np.sin(b2)) + 2*N21*s2ry*np.cos(b2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*DiracDelta(np.sin(b2))*np.sign(np.cos(a2))) + (-M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) - M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) - M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-N00*s2e*s2rx*np.sin(b2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2))**2/np.abs(np.cos(b2)) - 2*N00*s2rx*np.sin(b2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*DiracDelta(np.cos(b2))*np.sign(np.cos(a2)) + N01*s2e*s2ry*np.cos(b2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))**2*np.sign(np.cos(a2))/np.abs(np.sin(b2)) + 2*N01*s2ry*np.cos(b2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*DiracDelta(np.sin(b2))*np.sign(np.cos(a2)))

        res_ref[2,0] =  (-M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) - M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) - M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(M10*s1n*s1rx*np.sin(a1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))**2*np.sign(np.cos(b1))/np.abs(np.cos(a1)) + 2*M10*s1rx*np.sin(a1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*DiracDelta(np.cos(a1))*np.sign(np.cos(b1)) + M11*s1n*s1ry*np.sin(a1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1))**2/np.abs(np.cos(a1)) + 2*M11*s1ry*np.sin(a1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*DiracDelta(np.cos(a1))*np.sign(np.sin(b1)) - M12*s1n*s1rz*np.cos(a1)*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1))**2/np.abs(np.sin(a1)) - 2*M12*s1rz*np.cos(a1)*np.abs(np.sin(a1))**s1n*DiracDelta(np.sin(a1))) + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(M00*s1n*s1rx*np.sin(a1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))**2*np.sign(np.cos(b1))/np.abs(np.cos(a1)) + 2*M00*s1rx*np.sin(a1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*DiracDelta(np.cos(a1))*np.sign(np.cos(b1)) + M01*s1n*s1ry*np.sin(a1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1))**2/np.abs(np.cos(a1)) + 2*M01*s1ry*np.sin(a1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*DiracDelta(np.cos(a1))*np.sign(np.sin(b1)) - M02*s1n*s1rz*np.cos(a1)*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1))**2/np.abs(np.sin(a1)) - 2*M02*s1rz*np.cos(a1)*np.abs(np.sin(a1))**s1n*DiracDelta(np.sin(a1))) + (M00*s1ry*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(a1))*np.sign(np.cos(b1))/np.abs(np.cos(a1)) + M01*s1rx*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))*np.sign(np.cos(a1))/np.abs(np.cos(a1)) - M02*s1rx*s1ry*(2 - s1n)*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))**2*np.sign(np.cos(a1))/np.abs(np.sin(a1)) + 2*M02*s1rx*s1ry*np.sin(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.cos(a1))*np.sign(np.sin(a1)) - 2*M02*s1rx*s1ry*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.sin(a1))*np.sign(np.cos(a1)))*(-M10*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M11*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M12*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N10*s2rx*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2)) + N11*s2ry*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2)) + N12*s2rz*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2)) - s1yc + s2yc) + (-M10*s1ry*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(a1))*np.sign(np.cos(b1))/np.abs(np.cos(a1)) - M11*s1rx*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))*np.sign(np.cos(a1))/np.abs(np.cos(a1)) + M12*s1rx*s1ry*(2 - s1n)*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))**2*np.sign(np.cos(a1))/np.abs(np.sin(a1)) - 2*M12*s1rx*s1ry*np.sin(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.cos(a1))*np.sign(np.sin(a1)) + 2*M12*s1rx*s1ry*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.sin(a1))*np.sign(np.cos(a1)))*(-M00*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M01*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M02*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N00*s2rx*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2)) + N01*s2ry*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2)) + N02*s2rz*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2)) - s1xc + s2xc)

        res_ref[2,1] = (-M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) - M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) - M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(M10*s1e*s1rx*np.sin(b1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) + 2*M10*s1rx*np.sin(b1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*DiracDelta(np.cos(b1))*np.sign(np.cos(a1)) - M11*s1e*s1ry*np.cos(b1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))**2*np.sign(np.cos(a1))/np.abs(np.sin(b1)) - 2*M11*s1ry*np.cos(b1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*DiracDelta(np.sin(b1))*np.sign(np.cos(a1))) + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(M00*s1e*s1rx*np.sin(b1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) + 2*M00*s1rx*np.sin(b1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*DiracDelta(np.cos(b1))*np.sign(np.cos(a1)) - M01*s1e*s1ry*np.cos(b1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))**2*np.sign(np.cos(a1))/np.abs(np.sin(b1)) - 2*M01*s1ry*np.cos(b1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*DiracDelta(np.sin(b1))*np.sign(np.cos(a1))) + (M00*s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) + 2*M00*s1ry*s1rz*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*DiracDelta(np.cos(b1)) - M01*s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))**2/np.abs(np.sin(b1)) - 2*M01*s1rx*s1rz*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*DiracDelta(np.sin(b1)))*(-M10*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M11*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M12*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N10*s2rx*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2)) + N11*s2ry*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2)) + N12*s2rz*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2)) - s1yc + s2yc) + (-M10*s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) - 2*M10*s1ry*s1rz*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*DiracDelta(np.cos(b1)) + M11*s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))**2/np.abs(np.sin(b1)) + 2*M11*s1rx*s1rz*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*DiracDelta(np.sin(b1)))*(-M00*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M01*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M02*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N00*s2rx*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2)) + N01*s2ry*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2)) + N02*s2rz*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2)) - s1xc + s2xc)

        res_ref[2,2] =  (-M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) - M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) - M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-N10*s2n*s2rx*np.sin(a2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))**2*np.sign(np.cos(b2))/np.abs(np.cos(a2)) - 2*N10*s2rx*np.sin(a2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*DiracDelta(np.cos(a2))*np.sign(np.cos(b2)) - N11*s2n*s2ry*np.sin(a2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2))**2/np.abs(np.cos(a2)) - 2*N11*s2ry*np.sin(a2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*DiracDelta(np.cos(a2))*np.sign(np.sin(b2)) + N12*s2n*s2rz*np.cos(a2)*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2))**2/np.abs(np.sin(a2)) + 2*N12*s2rz*np.cos(a2)*np.abs(np.sin(a2))**s2n*DiracDelta(np.sin(a2))) + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-N00*s2n*s2rx*np.sin(a2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))**2*np.sign(np.cos(b2))/np.abs(np.cos(a2)) - 2*N00*s2rx*np.sin(a2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*DiracDelta(np.cos(a2))*np.sign(np.cos(b2)) - N01*s2n*s2ry*np.sin(a2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))*np.sign(np.cos(a2))**2/np.abs(np.cos(a2)) - 2*N01*s2ry*np.sin(a2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*DiracDelta(np.cos(a2))*np.sign(np.sin(b2)) + N02*s2n*s2rz*np.cos(a2)*np.abs(np.sin(a2))**s2n*np.sign(np.sin(a2))**2/np.abs(np.sin(a2)) + 2*N02*s2rz*np.cos(a2)*np.abs(np.sin(a2))**s2n*DiracDelta(np.sin(a2)))

        res_ref[2,3] = (-M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) - M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) - M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-N10*s2e*s2rx*np.sin(b2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2))**2/np.abs(np.cos(b2)) - 2*N10*s2rx*np.sin(b2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*DiracDelta(np.cos(b2))*np.sign(np.cos(a2)) + N11*s2e*s2ry*np.cos(b2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))**2*np.sign(np.cos(a2))/np.abs(np.sin(b2)) + 2*N11*s2ry*np.cos(b2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*DiracDelta(np.sin(b2))*np.sign(np.cos(a2))) + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-N00*s2e*s2rx*np.sin(b2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*np.sign(np.cos(a2))*np.sign(np.cos(b2))**2/np.abs(np.cos(b2)) - 2*N00*s2rx*np.sin(b2)*np.abs(np.cos(a2))**s2n*np.abs(np.cos(b2))**s2e*DiracDelta(np.cos(b2))*np.sign(np.cos(a2)) + N01*s2e*s2ry*np.cos(b2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*np.sign(np.sin(b2))**2*np.sign(np.cos(a2))/np.abs(np.sin(b2)) + 2*N01*s2ry*np.cos(b2)*np.abs(np.sin(b2))**s2e*np.abs(np.cos(a2))**s2n*DiracDelta(np.sin(b2))*np.sign(np.cos(a2)))

        res_ref[3,0] = ((M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-2*M00*s1ry*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(a1))*np.sign(np.cos(b1))/np.abs(np.cos(a1)) - 2*M01*s1rx*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))*np.sign(np.cos(a1))/np.abs(np.cos(a1)) + 2*M02*s1rx*s1ry*(2 - s1n)*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))**2*np.sign(np.cos(a1))/np.abs(np.sin(a1)) - 4*M02*s1rx*s1ry*np.sin(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.cos(a1))*np.sign(np.sin(a1)) + 4*M02*s1rx*s1ry*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.sin(a1))*np.sign(np.cos(a1)))/2 + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-2*M10*s1ry*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(a1))*np.sign(np.cos(b1))/np.abs(np.cos(a1)) - 2*M11*s1rx*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))*np.sign(np.cos(a1))/np.abs(np.cos(a1)) + 2*M12*s1rx*s1ry*(2 - s1n)*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))**2*np.sign(np.cos(a1))/np.abs(np.sin(a1)) - 4*M12*s1rx*s1ry*np.sin(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.cos(a1))*np.sign(np.sin(a1)) + 4*M12*s1rx*s1ry*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.sin(a1))*np.sign(np.cos(a1)))/2 + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-2*M20*s1ry*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(a1))*np.sign(np.cos(b1))/np.abs(np.cos(a1)) - 2*M21*s1rx*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))*np.sign(np.cos(a1))/np.abs(np.cos(a1)) + 2*M22*s1rx*s1ry*(2 - s1n)*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))**2*np.sign(np.cos(a1))/np.abs(np.sin(a1)) - 4*M22*s1rx*s1ry*np.sin(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.cos(a1))*np.sign(np.sin(a1)) + 4*M22*s1rx*s1ry*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.sin(a1))*np.sign(np.cos(a1)))/2)*np.sqrt((N00*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N01*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N02*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))**2 + (N10*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N11*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N12*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))**2 + (N20*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N21*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N22*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))**2)/np.sqrt((M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2 + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2 + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2) + (N00*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N01*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N02*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))*(-M00*s1ry*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(a1))*np.sign(np.cos(b1))/np.abs(np.cos(a1)) - M01*s1rx*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))*np.sign(np.cos(a1))/np.abs(np.cos(a1)) + M02*s1rx*s1ry*(2 - s1n)*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))**2*np.sign(np.cos(a1))/np.abs(np.sin(a1)) - 2*M02*s1rx*s1ry*np.sin(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.cos(a1))*np.sign(np.sin(a1)) + 2*M02*s1rx*s1ry*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.sin(a1))*np.sign(np.cos(a1))) + (N10*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N11*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N12*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))*(-M10*s1ry*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(a1))*np.sign(np.cos(b1))/np.abs(np.cos(a1)) - M11*s1rx*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))*np.sign(np.cos(a1))/np.abs(np.cos(a1)) + M12*s1rx*s1ry*(2 - s1n)*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))**2*np.sign(np.cos(a1))/np.abs(np.sin(a1)) - 2*M12*s1rx*s1ry*np.sin(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.cos(a1))*np.sign(np.sin(a1)) + 2*M12*s1rx*s1ry*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.sin(a1))*np.sign(np.cos(a1))) + (N20*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N21*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N22*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))*(-M20*s1ry*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(a1))*np.sign(np.cos(b1))/np.abs(np.cos(a1)) - M21*s1rx*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))*np.sign(np.cos(a1))/np.abs(np.cos(a1)) + M22*s1rx*s1ry*(2 - s1n)*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))**2*np.sign(np.cos(a1))/np.abs(np.sin(a1)) - 2*M22*s1rx*s1ry*np.sin(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.cos(a1))*np.sign(np.sin(a1)) + 2*M22*s1rx*s1ry*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.sin(a1))*np.sign(np.cos(a1)))

        res_ref[3,1] = ((M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-2*M00*s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) - 4*M00*s1ry*s1rz*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*DiracDelta(np.cos(b1)) + 2*M01*s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))**2/np.abs(np.sin(b1)) + 4*M01*s1rx*s1rz*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*DiracDelta(np.sin(b1)))/2 + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-2*M10*s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) - 4*M10*s1ry*s1rz*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*DiracDelta(np.cos(b1)) + 2*M11*s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))**2/np.abs(np.sin(b1)) + 4*M11*s1rx*s1rz*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*DiracDelta(np.sin(b1)))/2 + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-2*M20*s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) - 4*M20*s1ry*s1rz*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*DiracDelta(np.cos(b1)) + 2*M21*s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))**2/np.abs(np.sin(b1)) + 4*M21*s1rx*s1rz*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*DiracDelta(np.sin(b1)))/2)*np.sqrt((N00*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N01*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N02*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))**2 + (N10*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N11*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N12*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))**2 + (N20*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N21*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N22*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))**2)/np.sqrt((M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2 + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2 + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2) + (N00*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N01*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N02*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))*(-M00*s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) - 2*M00*s1ry*s1rz*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*DiracDelta(np.cos(b1)) + M01*s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))**2/np.abs(np.sin(b1)) + 2*M01*s1rx*s1rz*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*DiracDelta(np.sin(b1))) + (N10*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N11*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N12*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))*(-M10*s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) - 2*M10*s1ry*s1rz*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*DiracDelta(np.cos(b1)) + M11*s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))**2/np.abs(np.sin(b1)) + 2*M11*s1rx*s1rz*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*DiracDelta(np.sin(b1))) + (N20*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N21*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N22*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))*(-M20*s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) - 2*M20*s1ry*s1rz*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*DiracDelta(np.cos(b1)) + M21*s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))**2/np.abs(np.sin(b1)) + 2*M21*s1rx*s1rz*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*DiracDelta(np.sin(b1)))

        res_ref[3,2] =  ((N00*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N01*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N02*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))*(-2*N00*s2ry*s2rz*(2 - s2n)*np.sin(a2)*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(a2))*np.sign(np.cos(b2))/np.abs(np.cos(a2)) - 2*N01*s2rx*s2rz*(2 - s2n)*np.sin(a2)*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2))*np.sign(np.cos(a2))/np.abs(np.cos(a2)) + 2*N02*s2rx*s2ry*(2 - s2n)*np.cos(a2)*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))**2*np.sign(np.cos(a2))/np.abs(np.sin(a2)) - 4*N02*s2rx*s2ry*np.sin(a2)*np.abs(np.sin(a2))**(2 - s2n)*DiracDelta(np.cos(a2))*np.sign(np.sin(a2)) + 4*N02*s2rx*s2ry*np.cos(a2)*np.abs(np.sin(a2))**(2 - s2n)*DiracDelta(np.sin(a2))*np.sign(np.cos(a2)))/2 + (N10*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N11*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N12*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))*(-2*N10*s2ry*s2rz*(2 - s2n)*np.sin(a2)*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(a2))*np.sign(np.cos(b2))/np.abs(np.cos(a2)) - 2*N11*s2rx*s2rz*(2 - s2n)*np.sin(a2)*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2))*np.sign(np.cos(a2))/np.abs(np.cos(a2)) + 2*N12*s2rx*s2ry*(2 - s2n)*np.cos(a2)*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))**2*np.sign(np.cos(a2))/np.abs(np.sin(a2)) - 4*N12*s2rx*s2ry*np.sin(a2)*np.abs(np.sin(a2))**(2 - s2n)*DiracDelta(np.cos(a2))*np.sign(np.sin(a2)) + 4*N12*s2rx*s2ry*np.cos(a2)*np.abs(np.sin(a2))**(2 - s2n)*DiracDelta(np.sin(a2))*np.sign(np.cos(a2)))/2 + (N20*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N21*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N22*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))*(-2*N20*s2ry*s2rz*(2 - s2n)*np.sin(a2)*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(a2))*np.sign(np.cos(b2))/np.abs(np.cos(a2)) - 2*N21*s2rx*s2rz*(2 - s2n)*np.sin(a2)*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2))*np.sign(np.cos(a2))/np.abs(np.cos(a2)) + 2*N22*s2rx*s2ry*(2 - s2n)*np.cos(a2)*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))**2*np.sign(np.cos(a2))/np.abs(np.sin(a2)) - 4*N22*s2rx*s2ry*np.sin(a2)*np.abs(np.sin(a2))**(2 - s2n)*DiracDelta(np.cos(a2))*np.sign(np.sin(a2)) + 4*N22*s2rx*s2ry*np.cos(a2)*np.abs(np.sin(a2))**(2 - s2n)*DiracDelta(np.sin(a2))*np.sign(np.cos(a2)))/2)*np.sqrt((M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2 + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2 + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2)/np.sqrt((N00*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N01*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N02*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))**2 + (N10*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N11*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N12*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))**2 + (N20*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N21*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N22*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))**2) + (M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-N00*s2ry*s2rz*(2 - s2n)*np.sin(a2)*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(a2))*np.sign(np.cos(b2))/np.abs(np.cos(a2)) - N01*s2rx*s2rz*(2 - s2n)*np.sin(a2)*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2))*np.sign(np.cos(a2))/np.abs(np.cos(a2)) + N02*s2rx*s2ry*(2 - s2n)*np.cos(a2)*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))**2*np.sign(np.cos(a2))/np.abs(np.sin(a2)) - 2*N02*s2rx*s2ry*np.sin(a2)*np.abs(np.sin(a2))**(2 - s2n)*DiracDelta(np.cos(a2))*np.sign(np.sin(a2)) + 2*N02*s2rx*s2ry*np.cos(a2)*np.abs(np.sin(a2))**(2 - s2n)*DiracDelta(np.sin(a2))*np.sign(np.cos(a2))) + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-N10*s2ry*s2rz*(2 - s2n)*np.sin(a2)*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(a2))*np.sign(np.cos(b2))/np.abs(np.cos(a2)) - N11*s2rx*s2rz*(2 - s2n)*np.sin(a2)*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2))*np.sign(np.cos(a2))/np.abs(np.cos(a2)) + N12*s2rx*s2ry*(2 - s2n)*np.cos(a2)*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))**2*np.sign(np.cos(a2))/np.abs(np.sin(a2)) - 2*N12*s2rx*s2ry*np.sin(a2)*np.abs(np.sin(a2))**(2 - s2n)*DiracDelta(np.cos(a2))*np.sign(np.sin(a2)) + 2*N12*s2rx*s2ry*np.cos(a2)*np.abs(np.sin(a2))**(2 - s2n)*DiracDelta(np.sin(a2))*np.sign(np.cos(a2))) + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-N20*s2ry*s2rz*(2 - s2n)*np.sin(a2)*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(a2))*np.sign(np.cos(b2))/np.abs(np.cos(a2)) - N21*s2rx*s2rz*(2 - s2n)*np.sin(a2)*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2))*np.sign(np.cos(a2))/np.abs(np.cos(a2)) + N22*s2rx*s2ry*(2 - s2n)*np.cos(a2)*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))**2*np.sign(np.cos(a2))/np.abs(np.sin(a2)) - 2*N22*s2rx*s2ry*np.sin(a2)*np.abs(np.sin(a2))**(2 - s2n)*DiracDelta(np.cos(a2))*np.sign(np.sin(a2)) + 2*N22*s2rx*s2ry*np.cos(a2)*np.abs(np.sin(a2))**(2 - s2n)*DiracDelta(np.sin(a2))*np.sign(np.cos(a2)))

        res_ref[3,3] = ((N00*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N01*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N02*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))*(-2*N00*s2ry*s2rz*(2 - s2e)*np.sin(b2)*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2))**2/np.abs(np.cos(b2)) - 4*N00*s2ry*s2rz*np.sin(b2)*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*DiracDelta(np.cos(b2)) + 2*N01*s2rx*s2rz*(2 - s2e)*np.cos(b2)*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2))**2/np.abs(np.sin(b2)) + 4*N01*s2rx*s2rz*np.cos(b2)*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*DiracDelta(np.sin(b2)))/2 + (N10*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N11*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N12*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))*(-2*N10*s2ry*s2rz*(2 - s2e)*np.sin(b2)*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2))**2/np.abs(np.cos(b2)) - 4*N10*s2ry*s2rz*np.sin(b2)*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*DiracDelta(np.cos(b2)) + 2*N11*s2rx*s2rz*(2 - s2e)*np.cos(b2)*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2))**2/np.abs(np.sin(b2)) + 4*N11*s2rx*s2rz*np.cos(b2)*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*DiracDelta(np.sin(b2)))/2 + (N20*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N21*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N22*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))*(-2*N20*s2ry*s2rz*(2 - s2e)*np.sin(b2)*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2))**2/np.abs(np.cos(b2)) - 4*N20*s2ry*s2rz*np.sin(b2)*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*DiracDelta(np.cos(b2)) + 2*N21*s2rx*s2rz*(2 - s2e)*np.cos(b2)*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2))**2/np.abs(np.sin(b2)) + 4*N21*s2rx*s2rz*np.cos(b2)*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*DiracDelta(np.sin(b2)))/2)*np.sqrt((M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2 + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2 + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2)/np.sqrt((N00*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N01*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N02*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))**2 + (N10*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N11*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N12*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))**2 + (N20*s2ry*s2rz*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2)) + N21*s2rx*s2rz*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2)) + N22*s2rx*s2ry*np.abs(np.sin(a2))**(2 - s2n)*np.sign(np.sin(a2))*np.sign(np.cos(a2)))**2) + (M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-N00*s2ry*s2rz*(2 - s2e)*np.sin(b2)*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2))**2/np.abs(np.cos(b2)) - 2*N00*s2ry*s2rz*np.sin(b2)*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*DiracDelta(np.cos(b2)) + N01*s2rx*s2rz*(2 - s2e)*np.cos(b2)*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2))**2/np.abs(np.sin(b2)) + 2*N01*s2rx*s2rz*np.cos(b2)*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*DiracDelta(np.sin(b2))) + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-N10*s2ry*s2rz*(2 - s2e)*np.sin(b2)*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2))**2/np.abs(np.cos(b2)) - 2*N10*s2ry*s2rz*np.sin(b2)*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*DiracDelta(np.cos(b2)) + N11*s2rx*s2rz*(2 - s2e)*np.cos(b2)*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2))**2/np.abs(np.sin(b2)) + 2*N11*s2rx*s2rz*np.cos(b2)*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*DiracDelta(np.sin(b2))) + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-N20*s2ry*s2rz*(2 - s2e)*np.sin(b2)*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*np.sign(np.cos(b2))**2/np.abs(np.cos(b2)) - 2*N20*s2ry*s2rz*np.sin(b2)*np.abs(np.cos(a2))**(2 - s2n)*np.abs(np.cos(b2))**(2 - s2e)*DiracDelta(np.cos(b2)) + N21*s2rx*s2rz*(2 - s2e)*np.cos(b2)*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*np.sign(np.sin(b2))**2/np.abs(np.sin(b2)) + 2*N21*s2rx*s2rz*np.cos(b2)*np.abs(np.sin(b2))**(2 - s2e)*np.abs(np.cos(a2))**(2 - s2n)*DiracDelta(np.sin(b2)))
