...
namespace scopi
{
    void OptimUzawaMatrixFreeTbb::gemv_inv_P_moment(const scopi_container<2>& particles,
    ...
    void OptimUzawaMatrixFreeTbb::gemv_inv_P_moment(const scopi_container<3>& particles,
                                                    std::size_t active_offset,
                                                    std::size_t i)
    {
