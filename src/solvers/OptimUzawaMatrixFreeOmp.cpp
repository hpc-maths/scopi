...
namespace scopi
{
    void OptimUzawaMatrixFreeOmp::gemv_inv_P_moment(const scopi_container<2>& particles,
    ...
    void OptimUzawaMatrixFreeOmp::gemv_inv_P_moment(const scopi_container<3>& particles,
                                                    std::size_t active_offset,
                                                    std::size_t i)
    {
