...
namespace scopi{
    ...
    {
    protected:
        nesterov_restart(std::size_t max_iter, double rho, double tol_dg, double tol_l);
    ...
    nesterov_restart<projection_t>::nesterov_restart(std::size_t max_iter, double rho, double tol_dg, double tol_l)
    : projection_t()
    , m_max_iter(max_iter)
    , m_rho(rho)
    , m_tol_dg(tol_dg)
