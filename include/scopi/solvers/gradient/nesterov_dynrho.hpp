...
namespace scopi{
    ...
    {
    protected:
        nesterov_dynrho(std::size_t max_iter, double rho, double tol_dg, double tol_l);
    ...
    nesterov_dynrho<projection_t>::nesterov_dynrho(std::size_t max_iter, double rho, double tol_dg, double tol_l)
    : projection_t()
    , m_max_iter(max_iter)
    , m_rho(rho)
    , m_tol_dg(tol_dg)
