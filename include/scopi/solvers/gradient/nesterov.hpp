...
namespace scopi{
    ...
    template<class projection_t>
    int nesterov<projection_t>::projection(const sparse_matrix_t& A, const struct matrix_descr& descr, const xt::xtensor<double, 1>& c, xt::xtensor<double, 1>& l)
    {
        std::size_t iter = 0;
        double theta_old = 1.;
        m_y = l;
        ...
        while (iter < m_max_iter)
        {
            ...
            xt::noalias(m_y) = l + beta*(l - m_l_old);
