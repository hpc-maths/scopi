...
namespace scopi
{
    ...
    class ViscousBase
    {
      public:
        ...
        using contact_container_t = std::vector<neighbor<dim, Viscous>>;
        /**
      ...
      protected:
         ...
         */
        void set_gamma_base(const contact_container_t& contacts_new);

        /**
         * @brief Array of contacts at time \f$ t^n \f$.
         */
        contact_container_t m_contacts_old;
        /**
    ...
    template <std::size_t dim>
    void ViscousBase<dim>::set_gamma_base(const contact_container_t& contacts_new)
    {
