...
namespace scopi
{
     ...
     * - \f$ \mathbf{d}_{ij} + \mathbb{B} \mathbf{u}_{ij} \ge 0 \f$ if \f$ \g_{ij} = 0 \f$;
     * - \f$ \mathbf{d}_{ij} + \mathbb{B} \mathbf{u}_{ij} = 0 \f$ if \f$ \gm < \g_{ij} < 0 \f$;
     * - \f$ \mathbf{d}_{ij} + \mathbb{B} \mathbf{u}_{ij} \ge ||\mathbb{T} \mathbf{u}_{ij}|| \f$ if \f$ \g_{ij} < \gm \f$.
     *
