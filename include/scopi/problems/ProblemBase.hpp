...
namespace scopi
{
    ...
    class ProblemBase
    {
      public:
        ...
        void
        matrix_free_gemv_inv_P(const scopi_container<dim>& particles, xt::xtensor<double, 1>& U, std::size_t active_offset, std::size_t row);
      ...
      protected:
        ...
        void matrix_positive_distance(const scopi_container<dim>& particles, const Contacts& contacts, std::size_t nb_row_per_contact);
      ...
      private:
        ...
        /**
         * @brief 2D implementation of rows in matrix-free product \f$ \mathbf{u} = \mathbb{P}^{-1} \mathbf{u} \f$ that involve moments of
         * inertia.
         *
        ...
        void matrix_free_gemv_inv_P_moment(const scopi_container<2>& particles,
                                           ...
                                           std::size_t row);
        /**
         * @brief 3D implementation of rows in matrix-free product \f$ \mathbf{u} = \mathbb{P}^{-1} \mathbf{u} \f$ that involve moments of
         * inertia.
         *
         * Some rows in matrix_free_gemv_inv_P involve the moment of inertia.
         * The implentation is different in 2D or in 3D.
