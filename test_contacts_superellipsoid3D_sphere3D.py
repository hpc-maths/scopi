...
class SuperEllipsoid3D:
    ...
    def calcul_formel(self):
        ...
        s2Mr = sympy.Matrix([[ N00, N01, N02, 0 ],
                           ...
                           [ N20, N21, N22, 0 ],
                           [ 0,0,0,1]])
        s2r,s2xc,s2yc,s2zc = sympy.symbols("s2r,s2xc,s2yc,s2zc",real=True)
        s2Ms= sympy.Matrix([[s2r,0,0,0],[0,s2r,0,0],[0,0,s2r,0],[0,0,0,1]])
        ...
        s2nx = s2r*s2r*cos(a2)*cos(b2)
        s2ny = s2r*s2r*cos(a2)*sin(b2)
        s2nz = s2r*s2r*sin(a2)
...
if __name__ == '__main__':
    ...
    s2 = SuperEllipsoid3D(5,4,4, 1,1,1, n=1, e=1, theta=14, w = [1,1,1])
    s1.calcul_formel()
    # sys.exit()
    L = 10
    ...
    def f_contacts(u,s1,s2):
        ...
        if (s2rx != s2ry) or (s2rz != s2ry) or (s2e != 1) or (s2n != 1):
            print("s2 doit etre une sphere ! rx=ry=rz=r et e=n=1")
            sys.exit()
        s2r = s2rx
        ...
        A1 = s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))
        A2 = s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))
        A3 = s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1))
        A4 = s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1))
        A5 = s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1))
        A6 = s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1))
        B1 = s2r*np.sin(a2)
        B2 = s2r*np.cos(a2)*np.cos(b2)
        B3 = s2r*np.sin(b2)*np.cos(a2)

        res[0] = -(  M10*A1 + M11*A2 + M12*A3 ) * ( -M20*A4 - M21*A5 - M22*A6 + N20*B2 + N21*B3 + N22*B1 - s1zc + s2zc ) + \
                  (  M20*A1 + M21*A2 + M22*A3 ) * ( -M10*A4 - M11*A5 - M12*A6 + N10*B2 + N11*B3 + N12*B1 - s1yc + s2yc )
        res[1] =  (  M00*A1 + M01*A2 + M02*A3 ) * ( -M20*A4 - M21*A5 - M22*A6 + N20*B2 + N21*B3 + N22*B1 - s1zc + s2zc ) - \
                  (  M20*A1 + M21*A2 + M22*A3 ) * ( -M00*A4 - M01*A5 - M02*A6 + N00*B2 + N01*B3 + N02*B1 - s1xc + s2xc )
        res[2] = -(  M00*A1 + M01*A2 + M02*A3 ) * ( -M10*A4 - M11*A5 - M12*A6 + N10*B2 + N11*B3 + N12*B1 - s1yc + s2yc ) + \
                  (  M10*A1 + M11*A2 + M12*A3 ) * ( -M00*A4 - M01*A5 - M02*A6 + N00*B2 + N01*B3 + N02*B1 - s1xc + s2xc )
        res[3] =  (  N00*s2r*B2 + N01*s2r*B3 + N02*s2r*B1 ) * ( M00*A1 + M01*A2 + M02*A3 ) + \
                  (  N10*s2r*B2 + N11*s2r*B3 + N12*s2r*B1 ) * ( M10*A1 + M11*A2 + M12*A3 ) + \
                  (  N20*s2r*B2 + N21*s2r*B3 + N22*s2r*B1 ) * ( M20*A1 + M21*A2 + M22*A3 ) + \
                  s2r*np.sqrt( (N00*B2 + N01*B3 + N02*B1)**2 + (N10*B2 + N11*B3 + N12*B1)**2 + (N20*B2 + N21*B3 + N22*B1)**2 ) * \
                  np.sqrt( (M00*A1 + M01*A2 + M02*A3)**2 + (M10*A1 + M11*A2 + M12*A3)**2 + (M20*A1 + M21*A2 + M22*A3)**2 )
        """

        # final_pt1 =  [[0.34208361 0.8729701  0.88655326]]
        # final_pt2 =  [[4.27404206 3.5126348  3.51475755]]
        ...
        res_ref = np.zeros((4,))
        res_ref[0] = -(M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-M20*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M21*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M22*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N20*s2r*np.cos(a2)*np.cos(b2) + N21*s2r*np.sin(b2)*np.cos(a2) + N22*s2r*np.sin(a2) - s1zc + s2zc) + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-M10*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M11*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M12*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N10*s2r*np.cos(a2)*np.cos(b2) + N11*s2r*np.sin(b2)*np.cos(a2) + N12*s2r*np.sin(a2) - s1yc + s2yc)
        res_ref[1] = (M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-M20*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M21*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M22*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N20*s2r*np.cos(a2)*np.cos(b2) + N21*s2r*np.sin(b2)*np.cos(a2) + N22*s2r*np.sin(a2) - s1zc + s2zc) - (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-M00*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M01*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M02*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N00*s2r*np.cos(a2)*np.cos(b2) + N01*s2r*np.sin(b2)*np.cos(a2) + N02*s2r*np.sin(a2) - s1xc + s2xc)
        res_ref[2] = -(M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-M10*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M11*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M12*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N10*s2r*np.cos(a2)*np.cos(b2) + N11*s2r*np.sin(b2)*np.cos(a2) + N12*s2r*np.sin(a2) - s1yc + s2yc) + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-M00*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M01*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M02*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N00*s2r*np.cos(a2)*np.cos(b2) + N01*s2r*np.sin(b2)*np.cos(a2) + N02*s2r*np.sin(a2) - s1xc + s2xc)
        res_ref[3] = (N00*s2r**2*np.cos(a2)*np.cos(b2) + N01*s2r**2*np.sin(b2)*np.cos(a2) + N02*s2r**2*np.sin(a2))*(M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1))) + (N10*s2r**2*np.cos(a2)*np.cos(b2) + N11*s2r**2*np.sin(b2)*np.cos(a2) + N12*s2r**2*np.sin(a2))*(M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1))) + (N20*s2r**2*np.cos(a2)*np.cos(b2) + N21*s2r**2*np.sin(b2)*np.cos(a2) + N22*s2r**2*np.sin(a2))*(M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1))) + np.sqrt((N00*s2r**2*np.cos(a2)*np.cos(b2) + N01*s2r**2*np.sin(b2)*np.cos(a2) + N02*s2r**2*np.sin(a2))**2 + (N10*s2r**2*np.cos(a2)*np.cos(b2) + N11*s2r**2*np.sin(b2)*np.cos(a2) + N12*s2r**2*np.sin(a2))**2 + (N20*s2r**2*np.cos(a2)*np.cos(b2) + N21*s2r**2*np.sin(b2)*np.cos(a2) + N22*s2r**2*np.sin(a2))**2)*np.sqrt((M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2 + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2 + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2)
        #
    ...
    def grad_f_contacts(u,s1,s2):
        ...
        B10 = s2r * sb2 * ca2
        B11 = s2r * cb2 * ca2
        B12 = s2r**2 * sa2 * ca2n3 * cb2
        B13 = s2r**2 * sa2 * sb2 * ca2n3
        B14 = s2r**2 * np.abs(ca2)
        B15 = s2r**2 * sb2 * ca2n2
        B16 = s2r**2 * cb2 * ca2n2
        ...
        A5 = s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1))
        A6 = s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1))
        A7 = s1n*s1rx*np.sin(a1)*np.abs(np.cos(a1))**(s1n - 1)*np.abs(np.cos(b1))**s1e*np.sign(np.cos(b1))
        A8 = s1n*s1ry*np.sin(a1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**(s1n - 1)*np.sign(np.sin(b1))
        A9 = s1ry*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.cos(a1))**(1 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(a1))*np.sign(np.cos(b1))
        A10 = s1rx*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(1 - s1n)*np.sign(np.sin(b1))*np.sign(np.cos(a1))
        A11 = s1e*s1rx*np.sin(b1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**(s1e - 1)*np.sign(np.cos(a1))
        A12 = s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(1 - s1e)*np.abs(np.cos(a1))**(2 - s1n)
        A13 = s1rx*s1ry*(2 - s1n)*np.cos(a1)*np.abs(np.sin(a1))**(1 - s1n)*np.sign(np.cos(a1))
        A14 = s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(1 - s1e)
        A15 = s1e*s1ry*np.cos(b1)*np.abs(np.sin(b1))**(s1e - 1)*np.abs(np.cos(a1))**s1n*np.sign(np.cos(a1))
        A16 = s1n*s1rz*np.cos(a1)*np.abs(np.sin(a1))**(s1n - 1)

        B1 = s2r*np.sin(a2)
        B2 = s2r*np.cos(a2)*np.cos(b2)
        B3 = s2r*np.sin(b2)*np.cos(a2)
        B4 = s2r*np.cos(a2)
        B5 = s2r*np.sin(a2)*np.sin(b2)
        B6 =  s2r*np.sin(a2)*np.cos(b2)

        res[0,0] = ( -M10*A1 - M11*A2 - M12*A3 ) * (  M20*A7 + M21*A8 - M22*A16 ) + \
                   (  M20*A1 + M21*A2 + M22*A3 ) * (  M10*A7 + M11*A8 - M12*A16 ) + \
                   (  M10*A9 + M11*A10 - M12*A13 ) * ( -M20*A4 - M21*A5 - M22*A6 + N20*B2 + N21*B3 + N22*B1 - s1zc + s2zc ) + \
                   ( -M20*A9 - M21*A10 + M22*A13 ) * ( -M10*A4 - M11*A5 - M12*A6 + N10*B2 + N11*B3 + N12*B1 - s1yc + s2yc )

        res[0,1] = ( -M10*A1 - M11*A2 - M12*A3 ) * (  M20*A11 - M21*A15 ) + \
                   (  M20*A1 + M21*A2 + M22*A3 ) * (  M10*A11 - M11*A15 ) + \
                   (  M10*A14 - M11*A12 ) * ( -M20*A4 - M21*A5 - M22*A6 + N20*B2 + N21*B3 + N22*B1 - s1zc + s2zc ) + \
                   ( -M20*A14 + M21*A12 ) * ( -M10*A4 - M11*A5 - M12*A6 + N10*B2 + N11*B3 + N12*B1 - s1yc + s2yc )

        res[0,2] = ( -N10*B6 - N11*B5 + N12*B4 ) * (  M20*A1 + M21*A2 + M22*A3 ) + \
                   ( -N20*B6 - N21*B5 + N22*B4 ) * ( -M10*A1 - M11*A2 - M12*A3 )

        res[0,3] = ( -N10*B3 + N11*B2 ) * (  M20*A1 + M21*A2 + M22*A3 ) + \
                   ( -N20*B3 + N21*B2 ) * ( -M10*A1 - M11*A2 - M12*A3 )

        res[1,0] = (  M00*A1 + M01*A2 + M02*A3 ) * (  M20*A7 + M21*A8 - M22*A16 ) + \
                   ( -M20*A1 - M21*A2 - M22*A3 ) * (  M00*A7 + M01*A8 - M02*A16 ) + \
                   ( -M00*A9 - M01*A10 + M02*A13 ) * ( -M20*A4 - M21*A5 - M22*A6 + N20*B2 + N21*B3 + N22*B1 - s1zc + s2zc ) + \
                   (  M20*A9 + M21*A10 - M22*A13 ) * ( -M00*A4 - M01*A5 - M02*A6 + N00*B2 + N01*B3 + N02*B1 - s1xc + s2xc )

        res[1,1] = (  M00*A1 + M01*A2 + M02*A3 ) * (  M20*A11 - M21*A15 ) + \
                   ( -M20*A1 - M21*A2 - M22*A3 ) * (  M00*A11 - M01*A15 ) + \
                   ( -M00*A14 + M01*A12 ) * ( -M20*A4 - M21*A5 - M22*A6 + N20*B2 + N21*B3 + N22*B1 - s1zc + s2zc ) + \
                   (  M20*A14 - M21*A12 ) * ( -M00*A4 - M01*A5 - M02*A6 + N00*B2 + N01*B3 + N02*B1 - s1xc + s2xc )

        res[1,2] = ( -N00*B6 - N01*B5 + N02*B4 ) * ( -M20*A1 - M21*A2 - M22*A3 ) + \
                   ( -N20*B6 - N21*B5 + N22*B4 ) * (  M00*A1 + M01*A2 + M02*A3 )

        res[1,3] = ( -N00*B3 + N01*B2 ) * ( -M20*A1 - M21*A2 - M22*A3 ) + \
                   ( -N20*B3 + N21*B2 ) * (  M00*A1 + M01*A2 + M02*A3 )

        res[2,0] = ( -M00*A1 - M01*A2 - M02*A3 ) * (  M10*A7 + M11*A8 - M12*A16 ) + \
                   (  M10*A1 + M11*A2 + M12*A3 ) * (  M00*A7 + M01*A8 - M02*A16 ) + \
                   (  M00*A9 + M01*A10 - M02*A13 ) * ( -M10*A4 - M11*A5 - M12*A6 + N10*B2 + N11*B3 + N12*B1 - s1yc + s2yc ) + \
                   ( -M10*A9 - M11*A10 + M12*A13 ) * ( -M00*A4 - M01*A5 - M02*A6 + N00*B2 + N01*B3 + N02*B1 - s1xc + s2xc )

        res[2,1] = ( -M00*A1 - M01*A2 - M02*A3 ) * (  M10*A11 - M11*A15 ) + \
                   (  M10*A1 + M11*A2 + M12*A3 ) * (  M00*A11 - M01*A15 ) + \
                   (  M00*A14 - M01*A12 ) * ( -M10*A4 - M11*A5 - M12*A6 + N10*B2 + N11*B3 + N12*B1 - s1yc + s2yc ) + \
                   ( -M10*A14 + M11*A12 ) * ( -M00*A4 - M01*A5 - M02*A6 + N00*B2 + N01*B3 + N02*B1 - s1xc + s2xc )

        res[2,2] = ( -N00*B6 - N01*B5 + N02*B4 ) * (  M10*A1 + M11*A2 + M12*A3 ) + \
                   ( -N10*B6 - N11*B5 + N12*B4 ) * ( -M00*A1 - M01*A2 - M02*A3 )

        res[2,3] = ( -N00*B3 + N01*B2 ) * (  M10*A1 + M11*A2 + M12*A3 ) + \
                   ( -N10*B3 + N11*B2 ) * ( -M00*A1 - M01*A2 - M02*A3 )

        res[3,0] = ( (  M00*A1 + M01*A2 + M02*A3 ) * ( -M00*A9 - M01*A10 + M02*A13 ) + \
                     (  M10*A1 + M11*A2 + M12*A3 ) * ( -M10*A9 - M11*A10 + M12*A13 ) + \
                     (  M20*A1 + M21*A2 + M22*A3 ) * ( -M20*A9 - M21*A10 + M22*A13 ) \
                   ) * \
                   s2r * np.sqrt( (  N00*B2 + N01*B3 + N02*B1 )**2 + (  N10*B2 + N11*B3 + N12*B1 )**2 + (  N20*B2 + N21*B3 + N22*B1 )**2 ) \
                       / np.sqrt( (  M00*A1 + M01*A2 + M02*A3 )**2 + (  M10*A1 + M11*A2 + M12*A3 )**2 + (  M20*A1 + M21*A2 + M22*A3 )**2 ) + \
                   s2r * (  N00*B2 + N01*B3 + N02*B1 ) * (  -M00*A9 - M01*A10 + M02*A13 ) + \
                   s2r * (  N10*B2 + N11*B3 + N12*B1 ) * ( -M10*A9 - M11*A10 + M12*A13 ) + \
                   s2r * (  N20*B2 + N21*B3 + N22*B1 ) * ( -M20*A9 - M21*A10 + M22*A13 )

        res[3,1] = ( (  M00*A1 + M01*A2 + M02*A3 ) * ( -M00*A14 + M01*A12 ) + \
                     (  M10*A1 + M11*A2 + M12*A3 ) * ( -M10*A14 + M11*A12 ) + \
                     (  M20*A1 + M21*A2 + M22*A3 ) * ( -M20*A14 + M21*A12 ) \
                   ) * s2r * np.sqrt( (  N00*B2 + N01*B3 + N02*B1 )**2 + (  N10*B2 + N11*B3 + N12*B1 )**2 + (  N20*B2 + N21*B3 + N22*B1 )**2 ) \
                           / np.sqrt( (  M00*A1 + M01*A2 + M02*A3 )**2 + (  M10*A1 + M11*A2 + M12*A3 )**2 + (  M20*A1 + M21*A2 + M22*A3 )**2 ) + \
                   s2r * (  N00*B2 + N01*B3 + N02*B1 ) * ( -M00*A14 + M01*A12 ) + \
                   s2r * (  N10*B2 + N11*B3 + N12*B1 ) * ( -M10*A14 + M11*A12 ) + \
                   s2r * (  N20*B2 + N21*B3 + N22*B1 ) * ( -M20*A14 + M21*A12 )

        res[3,2] = ( ( -N00*B6 - N01*B5 + N02*B4 ) * (  N00*B2 + N01*B3 + N02*B1 ) + \
                     ( -N10*B6 - N11*B5 + N12*B4 ) * (  N10*B2 + N11*B3 + N12*B1 ) + \
                     ( -N20*B6 - N21*B5 + N22*B4 ) * (  N20*B2 + N21*B3 + N22*B1 ) \
                   )* s2r * np.sqrt( (  M00*A1 + M01*A2 + M02*A3 )**2 + (  M10*A1 + M11*A2 + M12*A3 )**2 + (  M20*A1 + M21*A2 + M22*A3 )**2) \
                          / np.sqrt( (  N00*B2 + N01*B3 + N02*B1 )**2 + (  N10*B2 + N11*B3 + N12*B1 )**2 + (  N20*B2 + N21*B3 + N22*B1 )**2 ) + \
                    s2r * ( -N00*B6 - N01*B5 + N02*B4 ) * (  M00*A1 + M01*A2 + M02*A3 ) + \
                    s2r * ( -N10*B6 - N11*B5 + N12*B4 ) * (  M10*A1 + M11*A2 + M12*A3 ) + \
                    s2r * ( -N20*B6 - N21*B5 + N22*B4 ) * (  M20*A1 + M21*A2 + M22*A3 )

        res[3,3] = s2r * ( -N00*B3 + N01*B2 ) * (  M00*A1 + M01*A2 + M02*A3 ) + \
                   s2r * ( -N10*B3 + N11*B2 ) * (  M10*A1 + M11*A2 + M12*A3 ) + \
                   s2r * ( -N20*B3 + N21*B2 ) * (  M20*A1 + M21*A2 + M22*A3 ) + \
                   ( ( -N00*B3 + N01*B2 ) * (  N00*B2 + N01*B3 + N02*B1 ) + \
                              ( -N10*B3 + N11*B2 ) * (  N10*B2 + N11*B3 + N12*B1 ) + \
                              ( -N20*B3 + N21*B2 ) * (  N20*B2 + N21*B3 + N22*B1 ) \
                   ) * s2r * np.sqrt( (  M00*A1 + M01*A2 + M02*A3 )**2 + (  M10*A1 + M11*A2 + M12*A3 )**2 + (  M20*A1 + M21*A2 + M22*A3 )**2 ) \
                           / np.sqrt( (  N00*B2 + N01*B3 + N02*B1 )**2 + (  N10*B2 + N11*B3 + N12*B1 )**2 + (  N20*B2 + N21*B3 + N22*B1 )**2 )
        """
        ...
        res_ref[1,1] =  (M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(M20*s1e*s1rx*np.sin(b1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) + 2*M20*s1rx*np.sin(b1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*DiracDelta(np.cos(b1))*np.sign(np.cos(a1)) - M21*s1e*s1ry*np.cos(b1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))**2*np.sign(np.cos(a1))/np.abs(np.sin(b1)) - 2*M21*s1ry*np.cos(b1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*DiracDelta(np.sin(b1))*np.sign(np.cos(a1))) + (-M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) - M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) - M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(M00*s1e*s1rx*np.sin(b1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) + 2*M00*s1rx*np.sin(b1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*DiracDelta(np.cos(b1))*np.sign(np.cos(a1)) - M01*s1e*s1ry*np.cos(b1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))**2*np.sign(np.cos(a1))/np.abs(np.sin(b1)) - 2*M01*s1ry*np.cos(b1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*DiracDelta(np.sin(b1))*np.sign(np.cos(a1))) + (-M00*s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) - 2*M00*s1ry*s1rz*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*DiracDelta(np.cos(b1)) + M01*s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))**2/np.abs(np.sin(b1)) + 2*M01*s1rx*s1rz*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*DiracDelta(np.sin(b1)))*(-M20*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M21*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M22*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N20*s2r*np.cos(a2)*np.cos(b2) + N21*s2r*np.sin(b2)*np.cos(a2) + N22*s2r*np.sin(a2) - s1zc + s2zc) + (M20*s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) + 2*M20*s1ry*s1rz*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*DiracDelta(np.cos(b1)) - M21*s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))**2/np.abs(np.sin(b1)) - 2*M21*s1rx*s1rz*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*DiracDelta(np.sin(b1)))*(-M00*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M01*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M02*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N00*s2r*np.cos(a2)*np.cos(b2) + N01*s2r*np.sin(b2)*np.cos(a2) + N02*s2r*np.sin(a2) - s1xc + s2xc)
        res_ref[1,2] =  (-N00*s2r*np.sin(a2)*np.cos(b2) - N01*s2r*np.sin(a2)*np.sin(b2) + N02*s2r*np.cos(a2))*(-M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) - M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) - M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1))) + (-N20*s2r*np.sin(a2)*np.cos(b2) - N21*s2r*np.sin(a2)*np.sin(b2) + N22*s2r*np.cos(a2))*(M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))
        res_ref[1,3] = (-N00*s2r*np.sin(b2)*np.cos(a2) + N01*s2r*np.cos(a2)*np.cos(b2))*(-M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) - M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) - M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1))) + (-N20*s2r*np.sin(b2)*np.cos(a2) + N21*s2r*np.cos(a2)*np.cos(b2))*(M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))
        res_ref[2,0] = (-M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) - M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) - M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(M10*s1n*s1rx*np.sin(a1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))**2*np.sign(np.cos(b1))/np.abs(np.cos(a1)) + 2*M10*s1rx*np.sin(a1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*DiracDelta(np.cos(a1))*np.sign(np.cos(b1)) + M11*s1n*s1ry*np.sin(a1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1))**2/np.abs(np.cos(a1)) + 2*M11*s1ry*np.sin(a1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*DiracDelta(np.cos(a1))*np.sign(np.sin(b1)) - M12*s1n*s1rz*np.cos(a1)*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1))**2/np.abs(np.sin(a1)) - 2*M12*s1rz*np.cos(a1)*np.abs(np.sin(a1))**s1n*DiracDelta(np.sin(a1))) + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(M00*s1n*s1rx*np.sin(a1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))**2*np.sign(np.cos(b1))/np.abs(np.cos(a1)) + 2*M00*s1rx*np.sin(a1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*DiracDelta(np.cos(a1))*np.sign(np.cos(b1)) + M01*s1n*s1ry*np.sin(a1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1))**2/np.abs(np.cos(a1)) + 2*M01*s1ry*np.sin(a1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*DiracDelta(np.cos(a1))*np.sign(np.sin(b1)) - M02*s1n*s1rz*np.cos(a1)*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1))**2/np.abs(np.sin(a1)) - 2*M02*s1rz*np.cos(a1)*np.abs(np.sin(a1))**s1n*DiracDelta(np.sin(a1))) + (M00*s1ry*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(a1))*np.sign(np.cos(b1))/np.abs(np.cos(a1)) + M01*s1rx*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))*np.sign(np.cos(a1))/np.abs(np.cos(a1)) - M02*s1rx*s1ry*(2 - s1n)*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))**2*np.sign(np.cos(a1))/np.abs(np.sin(a1)) + 2*M02*s1rx*s1ry*np.sin(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.cos(a1))*np.sign(np.sin(a1)) - 2*M02*s1rx*s1ry*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.sin(a1))*np.sign(np.cos(a1)))*(-M10*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M11*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M12*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N10*s2r*np.cos(a2)*np.cos(b2) + N11*s2r*np.sin(b2)*np.cos(a2) + N12*s2r*np.sin(a2) - s1yc + s2yc) + (-M10*s1ry*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(a1))*np.sign(np.cos(b1))/np.abs(np.cos(a1)) - M11*s1rx*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))*np.sign(np.cos(a1))/np.abs(np.cos(a1)) + M12*s1rx*s1ry*(2 - s1n)*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))**2*np.sign(np.cos(a1))/np.abs(np.sin(a1)) - 2*M12*s1rx*s1ry*np.sin(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.cos(a1))*np.sign(np.sin(a1)) + 2*M12*s1rx*s1ry*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.sin(a1))*np.sign(np.cos(a1)))*(-M00*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M01*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M02*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N00*s2r*np.cos(a2)*np.cos(b2) + N01*s2r*np.sin(b2)*np.cos(a2) + N02*s2r*np.sin(a2) - s1xc + s2xc)
        res_ref[2,1] =  (-M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) - M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) - M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(M10*s1e*s1rx*np.sin(b1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) + 2*M10*s1rx*np.sin(b1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*DiracDelta(np.cos(b1))*np.sign(np.cos(a1)) - M11*s1e*s1ry*np.cos(b1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))**2*np.sign(np.cos(a1))/np.abs(np.sin(b1)) - 2*M11*s1ry*np.cos(b1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*DiracDelta(np.sin(b1))*np.sign(np.cos(a1))) + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(M00*s1e*s1rx*np.sin(b1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) + 2*M00*s1rx*np.sin(b1)*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*DiracDelta(np.cos(b1))*np.sign(np.cos(a1)) - M01*s1e*s1ry*np.cos(b1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))**2*np.sign(np.cos(a1))/np.abs(np.sin(b1)) - 2*M01*s1ry*np.cos(b1)*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*DiracDelta(np.sin(b1))*np.sign(np.cos(a1))) + (M00*s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) + 2*M00*s1ry*s1rz*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*DiracDelta(np.cos(b1)) - M01*s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))**2/np.abs(np.sin(b1)) - 2*M01*s1rx*s1rz*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*DiracDelta(np.sin(b1)))*(-M10*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M11*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M12*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N10*s2r*np.cos(a2)*np.cos(b2) + N11*s2r*np.sin(b2)*np.cos(a2) + N12*s2r*np.sin(a2) - s1yc + s2yc) + (-M10*s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) - 2*M10*s1ry*s1rz*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*DiracDelta(np.cos(b1)) + M11*s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))**2/np.abs(np.sin(b1)) + 2*M11*s1rx*s1rz*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*DiracDelta(np.sin(b1)))*(-M00*s1rx*np.abs(np.cos(a1))**s1n*np.abs(np.cos(b1))**s1e*np.sign(np.cos(a1))*np.sign(np.cos(b1)) - M01*s1ry*np.abs(np.sin(b1))**s1e*np.abs(np.cos(a1))**s1n*np.sign(np.sin(b1))*np.sign(np.cos(a1)) - M02*s1rz*np.abs(np.sin(a1))**s1n*np.sign(np.sin(a1)) + N00*s2r*np.cos(a2)*np.cos(b2) + N01*s2r*np.sin(b2)*np.cos(a2) + N02*s2r*np.sin(a2) - s1xc + s2xc)
        res_ref[2,2] = (-N00*s2r*np.sin(a2)*np.cos(b2) - N01*s2r*np.sin(a2)*np.sin(b2) + N02*s2r*np.cos(a2))*(M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1))) + (-N10*s2r*np.sin(a2)*np.cos(b2) - N11*s2r*np.sin(a2)*np.sin(b2) + N12*s2r*np.cos(a2))*(-M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) - M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) - M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))
        res_ref[2,3] = (-N00*s2r*np.sin(b2)*np.cos(a2) + N01*s2r*np.cos(a2)*np.cos(b2))*(M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1))) + (-N10*s2r*np.sin(b2)*np.cos(a2) + N11*s2r*np.cos(a2)*np.cos(b2))*(-M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) - M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) - M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))
        res_ref[3,0] =  ((M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-2*M00*s1ry*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(a1))*np.sign(np.cos(b1))/np.abs(np.cos(a1)) - 2*M01*s1rx*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))*np.sign(np.cos(a1))/np.abs(np.cos(a1)) + 2*M02*s1rx*s1ry*(2 - s1n)*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))**2*np.sign(np.cos(a1))/np.abs(np.sin(a1)) - 4*M02*s1rx*s1ry*np.sin(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.cos(a1))*np.sign(np.sin(a1)) + 4*M02*s1rx*s1ry*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.sin(a1))*np.sign(np.cos(a1)))/2 + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-2*M10*s1ry*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(a1))*np.sign(np.cos(b1))/np.abs(np.cos(a1)) - 2*M11*s1rx*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))*np.sign(np.cos(a1))/np.abs(np.cos(a1)) + 2*M12*s1rx*s1ry*(2 - s1n)*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))**2*np.sign(np.cos(a1))/np.abs(np.sin(a1)) - 4*M12*s1rx*s1ry*np.sin(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.cos(a1))*np.sign(np.sin(a1)) + 4*M12*s1rx*s1ry*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.sin(a1))*np.sign(np.cos(a1)))/2 + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-2*M20*s1ry*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(a1))*np.sign(np.cos(b1))/np.abs(np.cos(a1)) - 2*M21*s1rx*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))*np.sign(np.cos(a1))/np.abs(np.cos(a1)) + 2*M22*s1rx*s1ry*(2 - s1n)*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))**2*np.sign(np.cos(a1))/np.abs(np.sin(a1)) - 4*M22*s1rx*s1ry*np.sin(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.cos(a1))*np.sign(np.sin(a1)) + 4*M22*s1rx*s1ry*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.sin(a1))*np.sign(np.cos(a1)))/2)*np.sqrt((N00*s2r**2*np.cos(a2)*np.cos(b2) + N01*s2r**2*np.sin(b2)*np.cos(a2) + N02*s2r**2*np.sin(a2))**2 + (N10*s2r**2*np.cos(a2)*np.cos(b2) + N11*s2r**2*np.sin(b2)*np.cos(a2) + N12*s2r**2*np.sin(a2))**2 + (N20*s2r**2*np.cos(a2)*np.cos(b2) + N21*s2r**2*np.sin(b2)*np.cos(a2) + N22*s2r**2*np.sin(a2))**2)/np.sqrt((M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2 + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2 + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2) + (N00*s2r**2*np.cos(a2)*np.cos(b2) + N01*s2r**2*np.sin(b2)*np.cos(a2) + N02*s2r**2*np.sin(a2))*(-M00*s1ry*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(a1))*np.sign(np.cos(b1))/np.abs(np.cos(a1)) - M01*s1rx*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))*np.sign(np.cos(a1))/np.abs(np.cos(a1)) + M02*s1rx*s1ry*(2 - s1n)*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))**2*np.sign(np.cos(a1))/np.abs(np.sin(a1)) - 2*M02*s1rx*s1ry*np.sin(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.cos(a1))*np.sign(np.sin(a1)) + 2*M02*s1rx*s1ry*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.sin(a1))*np.sign(np.cos(a1))) + (N10*s2r**2*np.cos(a2)*np.cos(b2) + N11*s2r**2*np.sin(b2)*np.cos(a2) + N12*s2r**2*np.sin(a2))*(-M10*s1ry*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(a1))*np.sign(np.cos(b1))/np.abs(np.cos(a1)) - M11*s1rx*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))*np.sign(np.cos(a1))/np.abs(np.cos(a1)) + M12*s1rx*s1ry*(2 - s1n)*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))**2*np.sign(np.cos(a1))/np.abs(np.sin(a1)) - 2*M12*s1rx*s1ry*np.sin(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.cos(a1))*np.sign(np.sin(a1)) + 2*M12*s1rx*s1ry*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.sin(a1))*np.sign(np.cos(a1))) + (N20*s2r**2*np.cos(a2)*np.cos(b2) + N21*s2r**2*np.sin(b2)*np.cos(a2) + N22*s2r**2*np.sin(a2))*(-M20*s1ry*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(a1))*np.sign(np.cos(b1))/np.abs(np.cos(a1)) - M21*s1rx*s1rz*(2 - s1n)*np.sin(a1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))*np.sign(np.cos(a1))/np.abs(np.cos(a1)) + M22*s1rx*s1ry*(2 - s1n)*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))**2*np.sign(np.cos(a1))/np.abs(np.sin(a1)) - 2*M22*s1rx*s1ry*np.sin(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.cos(a1))*np.sign(np.sin(a1)) + 2*M22*s1rx*s1ry*np.cos(a1)*np.abs(np.sin(a1))**(2 - s1n)*DiracDelta(np.sin(a1))*np.sign(np.cos(a1)))
        res_ref[3,1] =  ((M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-2*M00*s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) - 4*M00*s1ry*s1rz*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*DiracDelta(np.cos(b1)) + 2*M01*s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))**2/np.abs(np.sin(b1)) + 4*M01*s1rx*s1rz*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*DiracDelta(np.sin(b1)))/2 + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-2*M10*s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) - 4*M10*s1ry*s1rz*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*DiracDelta(np.cos(b1)) + 2*M11*s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))**2/np.abs(np.sin(b1)) + 4*M11*s1rx*s1rz*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*DiracDelta(np.sin(b1)))/2 + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))*(-2*M20*s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) - 4*M20*s1ry*s1rz*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*DiracDelta(np.cos(b1)) + 2*M21*s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))**2/np.abs(np.sin(b1)) + 4*M21*s1rx*s1rz*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*DiracDelta(np.sin(b1)))/2)*np.sqrt((N00*s2r**2*np.cos(a2)*np.cos(b2) + N01*s2r**2*np.sin(b2)*np.cos(a2) + N02*s2r**2*np.sin(a2))**2 + (N10*s2r**2*np.cos(a2)*np.cos(b2) + N11*s2r**2*np.sin(b2)*np.cos(a2) + N12*s2r**2*np.sin(a2))**2 + (N20*s2r**2*np.cos(a2)*np.cos(b2) + N21*s2r**2*np.sin(b2)*np.cos(a2) + N22*s2r**2*np.sin(a2))**2)/np.sqrt((M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2 + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2 + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2) + (N00*s2r**2*np.cos(a2)*np.cos(b2) + N01*s2r**2*np.sin(b2)*np.cos(a2) + N02*s2r**2*np.sin(a2))*(-M00*s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) - 2*M00*s1ry*s1rz*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*DiracDelta(np.cos(b1)) + M01*s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))**2/np.abs(np.sin(b1)) + 2*M01*s1rx*s1rz*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*DiracDelta(np.sin(b1))) + (N10*s2r**2*np.cos(a2)*np.cos(b2) + N11*s2r**2*np.sin(b2)*np.cos(a2) + N12*s2r**2*np.sin(a2))*(-M10*s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) - 2*M10*s1ry*s1rz*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*DiracDelta(np.cos(b1)) + M11*s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))**2/np.abs(np.sin(b1)) + 2*M11*s1rx*s1rz*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*DiracDelta(np.sin(b1))) + (N20*s2r**2*np.cos(a2)*np.cos(b2) + N21*s2r**2*np.sin(b2)*np.cos(a2) + N22*s2r**2*np.sin(a2))*(-M20*s1ry*s1rz*(2 - s1e)*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1))**2/np.abs(np.cos(b1)) - 2*M20*s1ry*s1rz*np.sin(b1)*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*DiracDelta(np.cos(b1)) + M21*s1rx*s1rz*(2 - s1e)*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1))**2/np.abs(np.sin(b1)) + 2*M21*s1rx*s1rz*np.cos(b1)*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*DiracDelta(np.sin(b1)))
        res_ref[3,2] =  ((-2*N00*s2r**2*np.sin(a2)*np.cos(b2) - 2*N01*s2r**2*np.sin(a2)*np.sin(b2) + 2*N02*s2r**2*np.cos(a2))*(N00*s2r**2*np.cos(a2)*np.cos(b2) + N01*s2r**2*np.sin(b2)*np.cos(a2) + N02*s2r**2*np.sin(a2))/2 + (-2*N10*s2r**2*np.sin(a2)*np.cos(b2) - 2*N11*s2r**2*np.sin(a2)*np.sin(b2) + 2*N12*s2r**2*np.cos(a2))*(N10*s2r**2*np.cos(a2)*np.cos(b2) + N11*s2r**2*np.sin(b2)*np.cos(a2) + N12*s2r**2*np.sin(a2))/2 + (-2*N20*s2r**2*np.sin(a2)*np.cos(b2) - 2*N21*s2r**2*np.sin(a2)*np.sin(b2) + 2*N22*s2r**2*np.cos(a2))*(N20*s2r**2*np.cos(a2)*np.cos(b2) + N21*s2r**2*np.sin(b2)*np.cos(a2) + N22*s2r**2*np.sin(a2))/2)*np.sqrt((M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2 + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2 + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2)/np.sqrt((N00*s2r**2*np.cos(a2)*np.cos(b2) + N01*s2r**2*np.sin(b2)*np.cos(a2) + N02*s2r**2*np.sin(a2))**2 + (N10*s2r**2*np.cos(a2)*np.cos(b2) + N11*s2r**2*np.sin(b2)*np.cos(a2) + N12*s2r**2*np.sin(a2))**2 + (N20*s2r**2*np.cos(a2)*np.cos(b2) + N21*s2r**2*np.sin(b2)*np.cos(a2) + N22*s2r**2*np.sin(a2))**2) + (-N00*s2r**2*np.sin(a2)*np.cos(b2) - N01*s2r**2*np.sin(a2)*np.sin(b2) + N02*s2r**2*np.cos(a2))*(M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1))) + (-N10*s2r**2*np.sin(a2)*np.cos(b2) - N11*s2r**2*np.sin(a2)*np.sin(b2) + N12*s2r**2*np.cos(a2))*(M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1))) + (-N20*s2r**2*np.sin(a2)*np.cos(b2) - N21*s2r**2*np.sin(a2)*np.sin(b2) + N22*s2r**2*np.cos(a2))*(M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))
        res_ref[3,3] =  (-N00*s2r**2*np.sin(b2)*np.cos(a2) + N01*s2r**2*np.cos(a2)*np.cos(b2))*(M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1))) + (-N10*s2r**2*np.sin(b2)*np.cos(a2) + N11*s2r**2*np.cos(a2)*np.cos(b2))*(M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1))) + (-N20*s2r**2*np.sin(b2)*np.cos(a2) + N21*s2r**2*np.cos(a2)*np.cos(b2))*(M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1))) + ((-2*N00*s2r**2*np.sin(b2)*np.cos(a2) + 2*N01*s2r**2*np.cos(a2)*np.cos(b2))*(N00*s2r**2*np.cos(a2)*np.cos(b2) + N01*s2r**2*np.sin(b2)*np.cos(a2) + N02*s2r**2*np.sin(a2))/2 + (-2*N10*s2r**2*np.sin(b2)*np.cos(a2) + 2*N11*s2r**2*np.cos(a2)*np.cos(b2))*(N10*s2r**2*np.cos(a2)*np.cos(b2) + N11*s2r**2*np.sin(b2)*np.cos(a2) + N12*s2r**2*np.sin(a2))/2 + (-2*N20*s2r**2*np.sin(b2)*np.cos(a2) + 2*N21*s2r**2*np.cos(a2)*np.cos(b2))*(N20*s2r**2*np.cos(a2)*np.cos(b2) + N21*s2r**2*np.sin(b2)*np.cos(a2) + N22*s2r**2*np.sin(a2))/2)*np.sqrt((M00*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M01*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M02*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2 + (M10*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M11*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M12*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2 + (M20*s1ry*s1rz*np.abs(np.cos(a1))**(2 - s1n)*np.abs(np.cos(b1))**(2 - s1e)*np.sign(np.cos(b1)) + M21*s1rx*s1rz*np.abs(np.sin(b1))**(2 - s1e)*np.abs(np.cos(a1))**(2 - s1n)*np.sign(np.sin(b1)) + M22*s1rx*s1ry*np.abs(np.sin(a1))**(2 - s1n)*np.sign(np.sin(a1))*np.sign(np.cos(a1)))**2)/np.sqrt((N00*s2r**2*np.cos(a2)*np.cos(b2) + N01*s2r**2*np.sin(b2)*np.cos(a2) + N02*s2r**2*np.sin(a2))**2 + (N10*s2r**2*np.cos(a2)*np.cos(b2) + N11*s2r**2*np.sin(b2)*np.cos(a2) + N12*s2r**2*np.sin(a2))**2 + (N20*s2r**2*np.cos(a2)*np.cos(b2) + N21*s2r**2*np.sin(b2)*np.cos(a2) + N22*s2r**2*np.sin(a2))**2)
