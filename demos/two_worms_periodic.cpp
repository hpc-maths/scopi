...
int main(int argc, char **argv)
{
    ...
    double radius = .01;
    std::vector<scopi::type::position_t<dim>> pos1(6), pos2(6);
    ...
    particles.push_back(w1, prop.desired_velocity({.5, 0.5}));
    particles.push_back(w2, prop.desired_velocity({-.5, -0.5}));
