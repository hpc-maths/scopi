...
int main()
{
    ...
    auto prop1 = scopi::property<dim>().desired_velocity({{0.25, 0, 0}});
    auto prop2 = scopi::property<dim>().desired_velocity({{-0.25, 0, 0}});
