...
int main()
{
    ...
    // Table 1: Disk placed on a plane without friction. Number of iterations for the APGD-AS algorithm and tolerance 10^{-3}.
    // The constraint is the first column in the log, the cost is the second column.
    plog::init(plog::verbose, "disk_on_inclined_plane_oneStep_apdgas_largeTol.log");
    ...
    scopi::Params<scopi::OptimProjectedGradient<scopi::DryWithoutFriction, scopi::nesterov_dynrho<>>, scopi::DryWithoutFriction, scopi::contact_kdtree, scopi::vap_fpd> params;
