...
int main()
{
    ...
    // of dt. mu = 0.1, convex scheme
    plog::init(plog::warning, "error_with_friction_mu01_convex.log");
    ...
    for (std::size_t i = 0; i < dt.size(); ++i)
    {
        ...
        {
            scopi::ScopiSolver<dim, scopi::OptimMosek<scopi::DryWithFriction>, scopi::contact_kdtree, scopi::vap_fpd> solver(particles,
                                                                                                                             dt[i]);
