...
int main()
{
    // Figure 2: Disk placed on a plane without friction. Evolution of the constraint and cost as a function of the iterations for the APGD-ASR algorithm.
    // Table 1: Disk placed on a plane without friction. Number of iterations for the APGD-ASR algorithm and tolerance 10^{-9}.
    // The constraint is the first column in the log, the cost is the second column.
    plog::init(plog::verbose, "disk_on_inclined_plane_oneStep_apdgasr_smallTol.log");
    ...
    scopi::Params<scopi::OptimProjectedGradient<scopi::DryWithoutFriction, scopi::apgd_asr>, scopi::DryWithoutFriction, scopi::contact_kdtree, scopi::vap_fpd> params;
