...
int main()
{
    ...
    // APGD-AR algorithm. Table 1: Disk placed on a plane without friction. Number of iterations for the APGD-AR algorithm and tolerance
    // 10^{-9}. The constraint is the first column in the log, the cost is the second column.
    plog::init(plog::verbose, "disk_on_inclined_plane_oneStep_apdgar_smallTol.log");
