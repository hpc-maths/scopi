...
int main()
{
    ...
    scopi::Params<scopi::OptimProjectedGradient<scopi::DryWithoutFriction, scopi::pgd>, scopi::contact_kdtree, scopi::vap_fpd> params;
    ...
    scopi::ScopiSolver<dim, scopi::OptimProjectedGradient<scopi::DryWithoutFriction, scopi::pgd>, scopi::contact_kdtree, scopi::vap_fpd> solver(particles, dt, params);
    solver.run(total_it);
