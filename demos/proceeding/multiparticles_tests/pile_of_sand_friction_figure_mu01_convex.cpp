...
int main()
{
    ...
    plog::init(plog::info, "pile_of_sand_spheres_figure_mu01_convex.log");
    ...
    scopi::Params<scopi::OptimMosek<scopi::DryWithoutFriction>, scopi::contact_kdtree, scopi::vap_fpd> params;
    ...
    params.scopi_params.path = "pile_sand_no_friction";
    params.scopi_params.filename = "nofriction_convex_";
    ...
    scopi::ScopiSolver<dim, scopi::OptimMosek<scopi::DryWithoutFriction>, scopi::contact_kdtree, scopi::vap_fpd> solver(particles, dt, params);
    solver.run(total_it);
