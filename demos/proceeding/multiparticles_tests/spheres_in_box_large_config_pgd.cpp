...
int main()
{
    // Figure 8 and table 3: spheres falling in a box with PGD solver and 50^3 spheres.
    plog::init(plog::info, "spheres_in_box_large_config_pgd.log");
    ...
    scopi::Params<scopi::OptimProjectedGradient<scopi::DryWithoutFriction, scopi::uzawa<>>, scopi::DryWithoutFriction, scopi::contact_kdtree, scopi::vap_fpd> params;
    ...
    scopi::ScopiSolver<dim, scopi::OptimProjectedGradient<scopi::DryWithoutFriction, scopi::uzawa<>>, scopi::contact_kdtree, scopi::vap_fpd> solver(particles, dt, params);
