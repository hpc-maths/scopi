...
int main()
{
    ...
    // scopi::ScopiSolver<dim, scopi::MosekSolver> mosek_solver(particles, dt, active_ptr);
    scopi::ScopiSolver<dim, scopi::ScsSolver> mosek_solver(particles, dt, active_ptr);
