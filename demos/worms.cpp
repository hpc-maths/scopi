...
#include <scopi/vap/vap_worm.hpp>

int main()
{
    plog::init(plog::error, "worms.log");
    ...
    scopi::worm<dim> g({{1., 0.7}, {3., 0.7}, {5., 0.7}, {7., 0.7}, {9., 0.7}, {11., 0.7}},
    ...
    scopi::ScopiSolver<dim, scopi::OptimMosek<scopi::DryWithoutFriction>, scopi::contact_kdtree, scopi::vap_worm> solver(particles, dt, params);
