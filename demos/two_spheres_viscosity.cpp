...
int main()
{
    ...
    scopi::sphere<dim> s2({{ 1., 0.05}}, r);
    scopi::sphere<dim> s3({{0., 0.3}}, r);
    scopi::sphere<dim> s4({{ 1., 0.35}}, r);
    ...
    particles.push_back(s1, prop.force({{1, 0}}));
    particles.push_back(s2, prop.force({{-1, 0}}));
    particles.push_back(s3, prop.force({{1, 0}}));
    particles.push_back(s4, prop.force({{-1, 0}}));
